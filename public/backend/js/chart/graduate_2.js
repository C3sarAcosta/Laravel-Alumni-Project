function charts_two(array_quality_teachers, array_syllabus, array_study_condition,
    array_experience, array_study_emphasis, array_participate_projects) {

    var labels_quality_teachers = array_quality_teachers.map(a => a.quality_teachers);
    ...
    var labels_study_condition = array_study_condition.map(a => a.study_condition);
    ...
    var labels_study_emphasis = array_study_emphasis.map(a => a.study_emphasis);
    ...
    var labels_participate_projects = array_participate_projects.map(a => a.participate_projects);
    var data_participate_projects = array_participate_projects.map(a => a.total);
