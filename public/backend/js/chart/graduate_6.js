function charts_six(array_organization_yes_no, array_agency_yes_no, array_association_yes_no) {

    var labels_organization_yes_no = array_organization_yes_no.map(a => a.organization_yes_no);
    var data_organization_yes_no = array_organization_yes_no.map(a => a.total);
    ...
    var labels_association_yes_no = array_association_yes_no.map(a => a.association_yes_no);
