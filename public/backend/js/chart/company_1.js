function charts_one(array_state, array_company_size, array_business_structure,
     array_business_activity_selector) {
        ...
        var labels_state = array_state.map(a => a.sex);
        ...
        var labels_company_size = array_company_size.map(a => a.sex);
        ...
        var labels_business_structure = array_business_structure.map(a => a.sex);
        ...
        var labels_business_activity_selector = array_business_activity_selector.map(a => a.sex);
