function charts_three(array_do_for_living, array_speciality, array_long_take_job, array_language_most_spoken,
    array_seniority, array_year, array_salary, array_management_level, array_job_condition,
    array_job_relationship, array_business_structure, array_company_size, array_business_activity_selector) {
    ...
    var labels_language_most_spoken = array_language_most_spoken.map(a => a.language_most_spoken);
    var data_language_most_spoken = array_language_most_spoken.map(a => a.total);
    ...
    var labels_management_level = array_management_level.map(a => a.management_level);
    ...
    var labels_job_relationship = array_job_relationship.map(a => a.job_relationship);
