...
<form method="post" action="{{ route('graduate.configuration.update') }}">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <input pattern="[0-9]{4}" title="Por favor ingrese un año correcto de 4 dígitos" type="text" id="year"
                    ...
                    oninput="setCustomValidity('')" value="{{ $editData->year_graduated }}" />
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="control_number" name="control_number" required
                    ...
                    placeholder="Número de Control" value="{{ $editData->control_number }}" />
            </div>
        </div>
    </div>
    ...
    <div class="row mt-2 d-flex justify-content-sm-center">
        <div class="col-4">
            <input type="submit" class="btn btn-block bg-gradient-primary" value="Editar Egresado">
        </div>
    </div>
</form>
