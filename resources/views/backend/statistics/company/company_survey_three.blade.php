...
<div class="row">
    <div class="col-12">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">¿Cómo considera su desempeño laboral respecto a su formación académica? Del total de egresados anote el
                porcentaje que corresponda.</h3>
